...
\titlespacing*{\subsubsection}{10pt}{-5pt}{5pt}
...
\begin{itemize}
    ...
    \item \textbf{Technologies:} React, React Native, Next.js, React Query, Redux, Styled Components, Testing Library, MSW, CSS Modules, SASS, Storybook, Node.js, Jest, Git, GitHub, Heroku, AWS, Firebase, Datadog, Retool
\end{itemize}
